...
parser.add_argument('--model_dir', type=str, default='MCF_Net/result/')
...
data_test = DatasetGenerator(data_dir=test_images_dir, transform1=transform_list_val1,
...
for ind in range(len(data_test)):
    result['name'].append( data_test.image_names[ind][7:] )
